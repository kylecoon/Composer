...
public class SceneChangeManager : MonoBehaviour
{
    ...
    private IEnumerator TransitionLevel(int l)
    {
        ...
        for (int i = 0; i < 50; ++i)
        {
            leftCurtain.GetComponent<RectTransform>().anchoredPosition = Vector3.Lerp(left_initial, new(0, -15.8f, 0), (i + 1) * 0.02f);
            rightCurtain.GetComponent<RectTransform>().anchoredPosition = Vector3.Lerp(right_initial, new(0, -15.8f, 0), (i + 1) * 0.02f);
        ...
        for (int i = 0; i < 50; ++i)
        {
            leftCurtain.GetComponent<RectTransform>().anchoredPosition = Vector3.Lerp(new(0, -15.8f, 0), left_initial, (i + 1) * 0.02f);
            rightCurtain.GetComponent<RectTransform>().anchoredPosition = Vector3.Lerp(new(0, -15.8f, 0), right_initial, (i + 1) * 0.02f);
            yield return new WaitForSeconds(0.015f);
        }
    }
}
